        ...
        >
          ...
          {imageUrl ? (
            ...
            <div className="flex flex-col items-center justify-center text-xs text-gray-700">
              ...
              <div className="mt-3">
                <Button disabled={disabled} className="bg-gray-800">select</Button>
              </div>
            </div>
          )}
  ...
  return (
    <button
      className={twMerge(
        ...
        // color
        'border border-gray-400 text-gray-400 shadow hover:bg-gray-100 hover:text-gray-500 dark:border-gray-600 dark:text-gray-100 dark:hover:bg-gray-900',
        // size
